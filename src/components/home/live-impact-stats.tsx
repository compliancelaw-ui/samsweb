...
export async function LiveImpactStats() {
  ...
  if (counts.totalOaths === 0) {
    return (
      <div>
        <p className="text-white/90 text-sm uppercase tracking-wider mb-8">
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
      <div>
        ...
        <p className="text-white/90">OATHs Taken</p>
      </div>
      <div>
        <p className="text-4xl md:text-5xl font-bold mb-2">
          {counts.totalStories}
        </p>
        <p className="text-white/90">Stories Shared</p>
      </div>
      <div className="col-span-2 md:col-span-1">
        <p className="text-4xl md:text-5xl font-bold mb-2">
          {counts.stateCount}
        </p>
        <p className="text-white/90">States Represented</p>
      </div>
    </div>
  );
}
