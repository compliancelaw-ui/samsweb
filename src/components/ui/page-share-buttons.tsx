    ...
    return (
      <div className="fixed right-4 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col gap-2">
        <a
          ...
          className="w-10 h-10 bg-white shadow-md rounded-full flex items-center justify-center text-gray-500 hover:text-blue-600 hover:shadow-lg transition-all"
        >
        ...
        <a
          ...
          rel="noopener noreferrer"
          title="Share on X"
          className="w-10 h-10 bg-white shadow-md rounded-full flex items-center justify-center text-gray-500 hover:text-gray-900 hover:shadow-lg transition-all"
        >
        ...
        <a
          ...
          className="w-10 h-10 bg-white shadow-md rounded-full flex items-center justify-center text-gray-500 hover:text-blue-700 hover:shadow-lg transition-all"
        >
        ...
        <button
          onClick={copyLink}
          title="Copy link"
          className="w-10 h-10 bg-white shadow-md rounded-full flex items-center justify-center text-gray-500 hover:text-teal hover:shadow-lg transition-all"
        >
          {copied ? <Check className="w-4 h-4 text-teal" /> : <LinkIcon className="w-4 h-4" />}
        </button>
      </div>
    );
  }
...
export function ShareCallToAction() {
  return (
    <div className="bg-gradient-to-r from-teal-50 to-primary-50 rounded-xl p-6 text-center">
      <Share2 className="w-8 h-8 mx-auto mb-3 text-teal" />
